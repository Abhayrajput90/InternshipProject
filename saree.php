...
@media screen and (min-width: 1200px){
    ...
    <main class="mt-5 mb-5">
        <h1 class="bd-grid mb-4 fw-bolder" style="color: #c3026d;">SAREE COLLECTION</h1>
        <main class="main bd-grid">
            <article class="card">
                ...
                <div class="card__name">
                    <p>IVORY GEOMETRIC EMBROIDERED SAREE SET</p>
                </div>
            ...
            <article class="card">
                <div class="card__img">
                    <img src="./images/saree2.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY GEOMETRIC EMBROIDERED SAREE SET</p>
                </div>
            ...
            <article class="card">
                <div class="card__img">
                    <img src="./images/saree3.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY GEOMETRIC EMBROIDERED SAREE SET</p>
                </div>
            ...
            <article class="card">
                <div class="card__img">
                    <img src="./images/saree4.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY GEOMETRIC EMBROIDERED SAREE SET</p>
                </div>
