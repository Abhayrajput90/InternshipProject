...
@media screen and (min-width: 1200px){
    ...
    <main class="mt-5 mb-5">
        <h1 class="bd-grid mb-4 fw-bolder" style="color: #c3026d;">LEHANGA COLLECTION</h1>
        <main class="main bd-grid">
            <article class="card">
                <div class="card__img">
                    <img src="./images/lehanga1.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY KASHMIRI SEQUIN LEHENGA</p>
                </div>
            ...
            <article class="card">
                <div class="card__img">
                    <img src="./images/lehanga 2.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY KASHMIRI SEQUIN LEHENGA</p>
                </div>
            ...
            <article class="card">
                <div class="card__img">
                    <img src="./images/lehanga3.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY KASHMIRI SEQUIN LEHENGA</p>
                </div>
            ...
            <article class="card">
                <div class="card__img">
                    <img src="./images/lehanga4.webp" alt="">
                </div>
                <div class="card__name">
                    <p>IVORY KASHMIRI SEQUIN LEHENGA</p>
                </div>
